...
INSTALLED_APPS=["daphne","django.contrib.admin","django.contrib.auth","django.contrib.contenttypes","django.contrib.sessions","django.contrib.messages","django.contrib.staticfiles","corsheaders","rest_framework","django_filters","drf_spectacular","channels","backend.apps.common","backend.apps.accounts","backend.apps.trading","backend.apps.risk","backend.apps.analytics_app","backend.apps.notifications","backend.apps.subscriptions","backend.apps.system","backend.apps.intelligence_app"]
